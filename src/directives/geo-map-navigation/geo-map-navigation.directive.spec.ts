...
import { AudificationModule } from './geo-map-navigation.module';
...
describe('AudificationDirective', () => {
  ...
  class WrapperComponent {
    ...
    @ViewChild(GeoMapNavigationDirective, { static: true }) directive: GeoMapNavigationDirective;
  }
  ...
  let directive: GeoMapNavigationDirective;
  ...
  it('should instantiate.', () => {
    expect(directive).toBeInstanceOf(GeoMapNavigationDirective);
  });
